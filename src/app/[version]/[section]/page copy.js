...
const contentMap = {
  "cloud-managed-auth": {
    ...
    "how-it-works": [{ type: "component", element: <HowItWorkContent key="1" /> }],
    "example-usage": [{ type: "component", element: <ExampleUsageContent key="1" /> }],
  },
  "locally-managed-auth": {
    ...
    "how-it-works": [{ type: "list", text: "Locally managed auth How-it-works content" }],
    "example-usage": [{ type: "list", text: "Locally managed auth Example usage content" }],
  },
  "plugin-driven": {
    "to-whom": [{ type: "list", text: "Plugin driven To-Whom content" }],
    provides: [{ type: "list", text: "Plugin driven Provides content" }],
    "how-it-works": [{ type: "list", text: "Plugin driven How-it-works content" }],
    "example-usage": [{ type: "list", text: "Plugin driven Example usage content" }],
  },
};
