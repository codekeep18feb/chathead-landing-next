export const clientIntegration = [
  {
    ...
    children: [
      ...
      {
        tag_type: "p",
        text: "Sageion boots in two ordered phases: setUp() prepares configuration and storage, and initialize() authenticates the user and mounts the chat UI. This page shows every supported way to wire them into a Vanilla JS app.",
      },
        ...
        children: [
          {
            ...
            items: [
              ...
              {
                text: "To split them across scripts, bridge them with a shared promise (see the Two-Block tab below).",
              },
            ],
          },
          {
      ...
      {
        tag_type: "p",
        text: "Choose the tab that matches your app's structure. All three are fully supported — they differ only in how setUp() and initialize() are sequenced.",
      },
      ...
      console.error("[Sageion] bootstrap failed:", err);
              ...
              },
              {
                ...
                children: [
                  {
                    tag_type: "p",
                    text: "Only the first three arguments are required. chat_root_id and version both have sensible defaults — most apps can simply write:",
                  },
                  {
                    tag_type: "code_with_copy",
                ...
                children: [
                  {
                    ...
                    rows: [
                      ["payload.uid", "string", "Required for V2/V3 when dont_show_chat_box_at_logout is enabled. Ignored for V1 (reads token from storage) and V4 (uses NO_AUTH_REQUIRED)."],
                    ],
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    tag_type: "p",
                    text: "Earlier versions of the SDK had header_req as the 4th argument. It has been removed — the auth header it controlled was a V1-only feature. If you were passing it, drop it and shift the remaining arguments left:",
                  },
                  {
                    tag_type: "table",
